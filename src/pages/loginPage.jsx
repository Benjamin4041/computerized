        ...
        <span className="m-auto flex flex-col justify-center items-center">
          <div className="flex gap-3 border-black border-4 w-fit pt-1 pb-1 pl-10 pr-10 rounded-full cursor-pointer">
            <span>
              ...
              >
                <path
                  d="M22.501 12.7332C22.501 11.8699 22.4295 11.2399 22.2748 10.5865H12.2153V14.4832H18.12C18.001 15.4515 17.3582 16.9099 15.9296 17.8898L15.9096 18.0203L19.0902 20.435L19.3106 20.4565C21.3343 18.6249 22.501 15.9298 22.501 12.7332"
                  fill="#4285F4"
                />
                <path
                ...
                />
                <path
                  d="M6.12046 14.5767C5.89428 13.9234 5.76337 13.2233 5.76337 12.5C5.76337 11.7767 5.89428 11.0767 6.10856 10.4234L6.10257 10.2842L2.75386 7.7356L2.64429 7.78667C1.91814 9.21002 1.50146 10.8084 1.50146 12.5C1.50146 14.1917 1.91814 15.79 2.64429 17.2133L6.12046 14.5767"
                  fill="#FBBC05"
                />
                <path
                  d="M12.2141 6.05997C14.2259 6.05997 15.583 6.91163 16.3569 7.62335L19.3807 4.73C17.5236 3.03834 15.1069 2 12.2141 2C8.02353 2 4.40447 4.35665 2.64258 7.78662L6.10686 10.4233C6.97598 7.89166 9.38073 6.05997 12.2141 6.05997"
                  fill="#EB4335"
                />
              </svg>
            </span>
      ...
      <div className="bg-amber-50 w-screen  lg:hidden absolute top-60 rounded-2xl p-6 ">
        ...
        >
          <span className="flex flex-col">
            ...
            <input
              type="email"
              className="border-stone-950 border-2 w-60 h-10 rounded-md pl-2"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
            />
          </span>
