      ...
      <div className="flex justify-center items-center lg:w-2/4">
        <div className="lg:block hidden">
          <form action="" className="flex flex-col gap-3">
            <span>
              ...
              <span className="relative">
                ...
                <input
                  ...
                  className="bg-slate-400 w-[13.2rem] h-8 rounded-lg pl-2"
                />
              </span>
            </span>
            <span>
            ...
            <button
              className="bg-[#C3C3C3] p-3 rounded-md mt-4"
              onClick={resetPass}
            >
              Change Password
            </button>
          ...
          <form action="" className="flex flex-col gap-3">
            <span>
              ...
              <span className="relative flex flex-col">
                <div
                  className="absolute   pt-2 pr-3 cursor-pointer w-fit self-end"
                  onClick={() => {
                    showPass === false ? setShowPass(true) : setShowPass(false);
                  }}
                >
                ...
                <input
                  ...
                  value={password}
                  onChange={(e) => setPassword(e.target.value)}
                  className="bg-slate-400 w-full h-8 rounded-lg pl-2"
                />
              </span>
            </span>
            <span>
